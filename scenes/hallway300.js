...
export class Hallway300 extends Phaser.Scene {
  ...
  create() {
   ...
   this.plataforma.crearPlataforma(566, 324, "paredNorte", plataformas, scale);
   this.plataforma.crearPlataforma(140, 556, "paredIzq", plataformas, scale);
   this.plataforma.crearPlataforma(1117, 229, "pared209", plataformas, scale);
   this.plataforma.crearPlataforma(1421, 452, "paredDer", plataformas, scale);
   this.plataforma.crearPlataforma(1195, 500, "paredHor1", plataformas, scale);
   this.plataforma.crearPlataforma(1036, 545, "paredHor2", plataformas, scale);
   this.plataforma.crearPlataforma(791, 543, "escalera1", plataformas, scale); 
   const escalera4 = this.add.image(1021, 605,  "escalera4");
   this.plataforma.crearPlataforma(789, 771, "paredSur", plataformas, scale);
