...
export class Auditorium2 extends Phaser.Scene {
  ...
  create() {
    ...
    crearPlataforma(1053, 500, "paredDere", plataformas, 0.997);
    crearPlataforma(768, 700, "fila1", plataformasillas);
    crearPlataforma(752, 652, "fila2", plataformasillas);
    crearPlataforma(800, 604, "fila3", plataformasillas);
    ...
    const salida = crearPlataforma(458, 587, "redV", paredPlataforma);
    ...
    createButtonCircle(this, SCENE.floor3, salida, 1161 , 640);
