...
this.plataforma.crearPlataforma(10, 417, "paredIzqC", plataformas, scale);
this.plataforma.crearPlataforma(634, 796, "paredPuertaIzq", plataformas, scale);

//    this.plataforma.crearPlataforma(420, 597, "cuadro", plataformas, scale);

this.avatar = new Avatar(this, 680, 870, 1.5);
// this.plataforma.crearPlataforma(690, 641, "paredPuertaSur", plataformas, scale);
this.plataforma.crearPlataforma(800, 137, "paredNorte", plataformas, scale);
this.plataforma.crearPlataforma(302, 680, "escritoriosA", plataformas, scale);
this.plataforma.crearPlataforma(561, 250, "escritoriosB", plataformas, scale);
this.plataforma.crearPlataforma(1190, 250, "escritorioB6", plataformas, scale);
this.plataforma.crearPlataforma(1502, 492, "escritoriosC", plataformas, scale);
this.plataforma.crearPlataforma(1005, 611, "escritoriosD", plataformas, scale);
const paredsur = this.add.image(322, 720, "paredSurEste");
this.plataforma.crearPlataforma(690, 947, "paredPuertaSur", plataformas, scale);
this.plataforma.crearPlataforma(761, 796, "paredPuertaDer", plataformas, scale);
const paredparedPuertaNor = this.add.image(698, 641, "paredPuertaNor");

this.plataforma.crearPlataforma(871, 829, "paredEscalera", plataformas, scale);

const paredSurDer = this.add.image(1298, 735, "paredSurDer",);
this.plataforma.crearPlataforma(1589, 423, "paredDer", plataformas, scale);



this.plataforma.crearPlataforma(877, 860, "escalera", plataformas, scale);

// const fondoColor = this.add.image(800, 500, "paredColor");
this.plataforma.crearPlataforma(1050, 240, "impresora", plataformas, scale);
this.plataforma.crearPlataforma(63, 192, "servidor", plataformas, scale);
this.plataforma.crearPlataforma(156, 146, "anaquel", plataformas, scale);
this.plataforma.crearPlataforma(480, 146, "anaquel", plataformas, scale);
this.plataforma.crearPlataforma(680, 146, "anaquel", plataformas, scale);
this.plataforma.crearPlataforma(830, 146, "anaquel", plataformas, scale);
this.plataforma.crearPlataforma(930, 146, "anaquel", plataformas, scale);
this.plataforma.crearPlataforma(1230, 146, "anaquel", plataformas, scale);

this.plataforma.crearPlataforma(1200, 226, "sillaB6", plataformas, scale);
