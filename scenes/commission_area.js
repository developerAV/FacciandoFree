...
export class CommissionArea extends Phaser.Scene {
  ...
  async create() {
   ...
   let escaleraComision = crearPlataforma(1254, 532, "escaleraComision", plataformas);
    ...
    let paredCentro2Izquierdacomision = crearPlataforma(1165, 396, "paredCentro2Izquierdacomision", plataformasMedio);
    let paredCentro2IzquierdacomisionOverlap = crearPlataforma(1165, 396, "paredCentro2Izquierdacomision", plataformasOverlap);
...
createButtonCircle(this, "mainHallway1", escaleraComision,1050, 780);
    ...
    this.physics.add.overlap(this.avatar.avatarPlayer, puertaOverlap1, () => {
      ...
      changeNameOverlap(this, areaPractica, "Area de Prácticas", "Pasillo Comisiones");

    }, null, this);
    this.physics.add.overlap(this.avatar.avatarPlayer, puertaOverlap2, () => {
